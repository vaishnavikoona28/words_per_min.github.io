...
<html lang="en">
    ...
    <body style="background-color:#848884;">
        <center><h1 style="color:white;font-size: 50px;margin-bottom: -10px;">TYPING TEST</h1></center>
        ...
        ?>
        <div style="text-align: right; margin-bottom: -20px; margin-right: 2%;font-size: 15px;color: white;">
            <?php echo "<strong>UserName : ".$USERNAME."</strong>" ?>
            <?php echo "<h4 onclick='logout()' style='color:white;cursor:grab'>logout</h4>" ?>
        </div>
        <div style="margin-top:5%">
            <div style="background-color: #a0d2eb;color: white;">
                <center>
        ...
        <center>
        <img src="typing.jpg" alt="typing" width=400 height=150>
        </center
    </body>
</html>
